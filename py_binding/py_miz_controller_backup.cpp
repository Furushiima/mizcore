...
PYBIND11_MODULE(py_miz_controller, m)
{
    ...
    py::class_<IdentifierToken,
      ...
      .def("set_ref_token", &IdentifierToken::SetRefToken)
      .def("get_ref_token",
           &IdentifierToken::GetRefToken,
    ...
    py::class_<TokenTable, std::shared_ptr<TokenTable>>(m, "TokenTable")
      .def(py::init<>())
      .def(
        "get_token", &TokenTable::GetToken, py::return_value_policy::reference)
    ...
    py::class_<ASTBlock, std::shared_ptr<ASTBlock>>(m, "ASTBlock")
      ...
      .def("get_first_token",
           &ASTBlock::GetFirstToken,
           py::return_value_policy::reference)
      .def("get_child_component_num", &ASTBlock::GetChildComponentNum)
      .def("get_child_component",
           &ASTBlock::GetChildComponent,
           py::return_value_policy::reference);
    ...
    py::class_<EmwikiInterface, std::shared_ptr<EmwikiInterface>>(
      ...
      .def("get_token_table", &EmwikiInterface::GetTokenTable)
      .def("get_ast_root", &EmwikiInterface::GetASTRoot)
      .def("get_error_table", &EmwikiInterface::GetErrorTable);
}